...
LIB-hotstuff-volt-interface := store/hotstuffstore/libhotstuff/examples/libindicus_interface.a store/hotstuffstore/libhotstuff/salticidae/libsalticidae.a store/hotstuffstore/libhotstuff/libhotstuff.a store/hotstuffstore/libhotstuff/secp256k1/.libs/libsecp256k1.a


LIB-pbft-batched-sigs := $(LIB-crypto) $(o)pbft_batched_sigs.o 

LIB-hotstuff-volt-store := $(o)common.o $(o)slots.o $(o)replica.o $(o)server.o \
	...
	$(LIB-transport) $(LIB-store-backend) $(LIB-hotstuff-volt-interface)
