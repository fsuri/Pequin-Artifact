...
//   //NOTE: Sintrstore functionality: Delete should essentially just be adding a dummy row marked as delete. Nothing more. //TODO: Should re-factor delete to use INSERT EXECUTOR interface
...
//       is_ownable = true;  //NOTE: All the ownership biz seems like it can be removed for Sintr //TODO: Remove what is not needed
//       if (is_ownable == true) {
