...
void test_read_query() {
  ...
  sintrstore::proto::CommittedProof *real_proof =
      new sintrstore::proto::CommittedProof();
  ...
  // Table Write 2:
  sintrstore::proto::CommittedProof *real_proof2 =
      new sintrstore::proto::CommittedProof();
  ...
  // Table Write 3:
  sintrstore::proto::CommittedProof *real_proof3 =
      new sintrstore::proto::CommittedProof();
  ...
  sintrstore::proto::CommittedProof *real_proof4 =
      new sintrstore::proto::CommittedProof();
  ...
  sintrstore::TableStore *table_store = new sintrstore::PelotonTableStore(16);
...
void test_committed_table_write() {
  ...
  Timestamp pesto_timestamp(4, 6);
  // sintrstore::proto::ReadSet read_set_one;
  // sintrstore::QueryReadSetMgr query_read_set_mgr_one(&read_set_one, 1,
  // false);
  ...
  // sintrstore::TableStore *table_store = new
  // sintrstore::PelotonTableStore();
  //   sintrstore::TableStore *table_store1 = new
  //   sintrstore::PelotonTableStore();

  // sintrstore::TableStore *table_store2 = new
  // sintrstore::PelotonTableStore(); sintrstore::TableStore *table_store3 =
  // new sintrstore::PelotonTableStore();
  ...
  sintrstore::TableStore *table_store1 =
      new sintrstore::PelotonTableStore(std::thread::hardware_concurrency());
  ...
  for (size_t i = 0; i < num_overwrites; i++) {
    ...
    //  t.join();
    // sintrstore::TableStore *t_store = new sintrstore::PelotonTableStore();
...
void test_read_predicate() {
  ...
  sintrstore::TableStore *table_store = new sintrstore::PelotonTableStore();
  sintrstore::proto::Write write;
  sintrstore::proto::CommittedProof committed_proof;
  std::string table_registry = file_name + "-tables-schema.json";
  table_store->RegisterTableSchema(table_registry);
