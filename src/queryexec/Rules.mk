...
SRCS += $(addprefix $(d), SQLParser.cc SQLParserResult.cc types.cc sql_identifier_resolver_proxy.cc sql_identifier_resolver.cc \
...
LIB-queryprocess := $(o)SQLParser.o $(o)SQLParserResult.o $(o)sql/Expr.o $(o)sql/SQLStatement.o $(o)sql/statements.o $(o)sql/CreateStatement.o $(o)sql/PrepareStatement.o $(o)types.o $(o)sql_identifier_resolver_proxy.o $(o)sql_identifier_resolver.o \
	$(o)sql_identifier.o $(o)util/sqlhelper.o \
...
$(d)queryexec-test: $(LIB-queryprocess) $(LIB-queryprocess-flex) $(o)queryexec-test.o
