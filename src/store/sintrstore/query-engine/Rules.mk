...
#PROTOS += $(addprefix $(d), ../store/common/sintr-proto.proto)
...
#$(d)queryexec-test: $(o)../store/sintrstore/sintr-proto.o $(o)../store/sintrstore/query-proto.o $(o)../store/common/query_result/query-result-proto.o $(o)../store/common/query_result/query_result_proto_builder.o $(o)../store/common/timestamp.o $(o)../store/common/common-proto.o $(o)../store/sintrstore/sintr-proto.o $(o)../lib/message.o $(o)../lib/crypto.o $(o)../lib/batched_sigs.o $(o)../lib/configuration.o $(o)../lib/keymanager.o $(o)../lib/transport.o $(o)../store/sintrstore/common.o $(o)../store/common/table_kv_encoder.o $(o)../store/sintrstore/table_store_interface.o $(o)../store/common/query_result/query_result_proto_wrapper_row.o $(o)../store/common/query_result/query_result_proto_wrapper_field.o $(o)../store/common/query_result/query_result_proto_wrapper.o $(o)../store/sintrstore/sql_interpreter.o $(LIB-binder) $(LIB-catalog) $(LIB-common) $(LIB-concurrency) $(LIB-executor) $(LIB-expression) $(LIB-function) $(LIB-gc) $(LIB-index) $(LIB-murmur) $(LIB-optimizer) $(LIB-parser) $(LIB-planner) $(LIB-settings) $(LIB-storage) $(LIB-threadpool) $(LIB-traffic-cop) $(LIB-type) $(LIB-trigger) $(LIB-util) $(LIB-store-common) $(o)queryexec-test.o

#BINS += $(d)queryexec-test

#$(o)../store/common/query_result/query_result_proto_builder.o 

#$(o)../store/common/timestamp.o $(o)../store/common/common-proto.o $(o)../store/sintrstore/sintr-proto.o $(o)../lib/message.o $(o)../lib/crypto.o $(o)../lib/batched_sigs.o $(o)../lib/configuration.o $(o)../lib/keymanager.o $(o)../lib/transport.o $(o)../store/sintrstore/common.o
