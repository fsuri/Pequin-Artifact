...
if [ $NUM_SHARDS = 2 ]; then
   arr_servers=("us-east-1-0" "us-east-1-1" "us-east-1-2" "us-east-2-0" "us-east-2-1" "us-east-2-2" "eu-west-1-0" "eu-west-1-1" "eu-west-1-2" "eu-west-2-0" "eu-west-2-1" "eu-west-2-2" )
...
if [ $NUM_SHARDS = 3 ]; then
   arr_servers=("us-east-1-0" "us-east-1-1" "us-east-1-2" "us-east-2-0" "us-east-2-1" "us-east-2-2" "us-west-1-0" "us-west-1-1" "us-west-1-2" "us-west-2-0" "us-west-2-1" "us-west-2-2" "eu-west-1-0" "eu-west-1-1" "eu-west-1-2" "eu-west-2-0" "eu-west-2-1" "eu-west-2-2")
