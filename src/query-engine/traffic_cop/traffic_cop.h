...
class TrafficCop {
 public:
  ...
  ResultType ExecuteStatement(
      ...
      Timestamp &basil_timestamp, pequinstore::QueryReadSetMgr &query_read_set_mgr, size_t thread_id = 0);
  ...
  executor::ExecutionResult ExecuteHelper(
      ...
      const std::vector<int> &result_format, Timestamp &basil_timestamp, pequinstore::QueryReadSetMgr &query_read_set_mgr, size_t thread_id = 0);
