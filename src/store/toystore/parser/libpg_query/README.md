# libpg_query modified by Peloton

C library for accessing the PostgreSQL parser outside of the server. This is the version that is modified by Peloton, with any extra patches needed to run natively on ARM.
