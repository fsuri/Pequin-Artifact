...
#include "store/sintrstore/query-engine/concurrency/transaction_context.h"
#include "store/sintrstore/query-engine/concurrency/transaction_manager.h"
#include "store/sintrstore/query-engine/planner/attribute_info.h"
#include "store/sintrstore/query-engine/storage/tile_group.h"
#include <memory>
...
void SeqScanExecutor::SetTableColVersions(concurrency::TransactionContext *current_txn, sintrstore::QueryReadSetMgr *query_read_set_mgr, const Timestamp &current_txn_timestamp){
...
void SeqScanExecutor::RefineTableColVersions(concurrency::TransactionContext *current_txn, sintrstore::QueryReadSetMgr *query_read_set_mgr){
...
void SeqScanExecutor::SetPredicate(concurrency::TransactionContext *current_txn, sintrstore::QueryReadSetMgr *query_read_set_mgr){
