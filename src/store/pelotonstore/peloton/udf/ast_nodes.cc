...
peloton_peloton::codegen::Value NumberExprAST::Codegen(
    peloton_peloton::codegen::CodeGen &codegen,
    UNUSED_ATTRIBUTE peloton_peloton::codegen::FunctionBuilder &fb) {
  auto number_codegen_val = peloton_peloton::codegen::Value(
      peloton_peloton::codegen::type::Type(type::TypeId::DECIMAL, false),
      codegen.ConstDouble(val));
  return number_codegen_val;
}

// Codegen for VariableExprAST
peloton_peloton::codegen::Value VariableExprAST::Codegen(
    UNUSED_ATTRIBUTE peloton_peloton::codegen::CodeGen &codegen,
    peloton_peloton::codegen::FunctionBuilder &fb) {
  llvm::Value *val = fb.GetArgumentByName(name);

  if (val) {
    return peloton_peloton::codegen::Value(
        peloton_peloton::codegen::type::Type(type::TypeId::DECIMAL, false), val);
  }
  return LogErrorV("Unknown variable name");
}

// Codegen for BinaryExprAST
peloton_peloton::codegen::Value BinaryExprAST::Codegen(
    peloton_peloton::codegen::CodeGen &codegen, peloton_peloton::codegen::FunctionBuilder &fb) {
  peloton_peloton::codegen::Value left = lhs->Codegen(codegen, fb);
  peloton_peloton::codegen::Value right = rhs->Codegen(codegen, fb);
...
peloton_peloton::codegen::Value CallExprAST::Codegen(
    peloton_peloton::codegen::CodeGen &codegen, peloton_peloton::codegen::FunctionBuilder &fb) {
  ...
  auto call_val = peloton_peloton::codegen::Value(
      peloton_peloton::codegen::type::Type(type::TypeId::DECIMAL, false), call_ret);

  return call_val;
}

peloton_peloton::codegen::Value IfExprAST::Codegen(
    peloton_peloton::codegen::CodeGen &codegen, peloton_peloton::codegen::FunctionBuilder &fb) {
  auto compare_value = peloton_peloton::codegen::Value(
      peloton_peloton::codegen::type::Type(type::TypeId::DECIMAL, false),
      codegen.ConstDouble(1.0));

  peloton_peloton::codegen::Value cond_expr_value = cond_expr->Codegen(codegen, fb);
  peloton_peloton::codegen::Value if_result;
  peloton_peloton::codegen::Value else_result;
  ...
  auto return_val = peloton_peloton::codegen::Value(
      peloton_peloton::codegen::type::Type(type::TypeId::DECIMAL, false), final_result);

  return return_val;
}

// Codegen for FunctionAST
llvm::Function *FunctionAST::Codegen(peloton_peloton::codegen::CodeGen &codegen,
                                     peloton_peloton::codegen::FunctionBuilder &fb) {
  peloton_peloton::codegen::Value ret = body->Codegen(codegen, fb);
...
peloton_peloton::codegen::Value LogErrorV(const char *str) {
  LogError(str);
  return peloton_peloton::codegen::Value();
}
