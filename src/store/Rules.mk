...
$(d)server: $(LIB-tapir-store) $(LIB-strong-store) $(LIB-weak-store) \
	...
	$(LIB-pequin-store) $(LIB-indicus-store) $(LIB-pbft-store) $(LIB-hotstuff-store) $(LIB-augustus-store) \
	$(LIB-bftsmart-store) $(LIB-bftsmart-augustus-store) $(LIB-bftsmart-stable-store) $(LIB-tpcc) $(LIB-hotstuff-volt-store)
