...
class Parameter {
 public:
  ...
  peloton_peloton::type::TypeId GetValueType() const { return type_id_; }

  // Get its nullability
  bool IsNullable() const { return is_nullable_; }

 private:
  Parameter(Type type, peloton_peloton::type::TypeId type_id, bool is_nullable)
 ...
 private:
  ...
  peloton_peloton::type::TypeId type_id_;
