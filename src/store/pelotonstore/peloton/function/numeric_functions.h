...
class NumericFunctions {
 public:
  ...
  static bool InputBoolean(const peloton_peloton::type::Type &type, const char *ptr,
                           uint32_t len);

  static int8_t InputTinyInt(const peloton_peloton::type::Type &type, const char *ptr,
                             uint32_t len);

  static int16_t InputSmallInt(const peloton_peloton::type::Type &type, const char *ptr,
                               uint32_t len);

  static int32_t InputInteger(const peloton_peloton::type::Type &type, const char *ptr,
                              uint32_t len);

  static int64_t InputBigInt(const peloton_peloton::type::Type &type, const char *ptr,
                             uint32_t len);

  static double InputDecimal(const peloton_peloton::type::Type &type, const char *ptr,
                             uint32_t len);
};
