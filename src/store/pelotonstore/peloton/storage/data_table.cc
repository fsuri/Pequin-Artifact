...
std::vector<peloton_peloton::oid_t> peloton_peloton_sdbench_column_ids;

double peloton_peloton_projectivity;

int peloton_peloton_num_groups;
...
DataTable::DataTable(catalog::Schema *schema, const std::string &table_name,
                     ...
                     const peloton_peloton::LayoutType layout_type)
          ...
          for (ItemPointer *ptr : location_ptrs) {
            ...
            switch (cons->GetFKUpdateAction()) {
              ...
              default: {
                ...
                peloton_peloton::ItemPointer location = src_table->InsertTuple(
