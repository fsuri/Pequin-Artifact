...
BaseTFModel::BaseTFModel(const std::string &modelgen_path,
    ...
    : BaseModel(),
      modelgen_path_(peloton_peloton::FileUtil::GetRelativeToRootPath(modelgen_path)),
      pymodel_path_(peloton_peloton::FileUtil::GetRelativeToRootPath(pymodel_path)),
      graph_path_(peloton_peloton::FileUtil::GetRelativeToRootPath(graph_path)) {
