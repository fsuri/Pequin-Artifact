...
SRCS += $(addprefix $(d), catalog/database_metrics_catalog.cc catalog/index_metrics_catalog.cc catalog/query_metrics_catalog.cc catalog/table_metrics_catalog.cc catalog/abstract_catalog.cc catalog/catalog_cache.cc catalog/catalog.cc catalog/column_catalog.cc catalog/column_stats_catalog.cc \
...
# Network
#SRCS += $(addprefix $(d), network/connection_dispatcher_task.cc network/connection_handle.cc network/connection_handler_task.cc network/marshal.cc network/network_io_wrapper_factory.cc network/network_io_wrappers.cc network/peloton_server.cc network/postgres_protocol_handler.cc network/protocol_handler_factory.cc network/protocol_handler.cc)
...
# ADR
LIB-adr-p := $(o)adaptive_radix_tree/Tree.o

# Binder
LIB-binder-p := $(o)binder/bind_node_visitor.o $(o)binder/binder_context.o
...
LIB-catalog-p := $(o)catalog/abstract_catalog.o $(o)catalog/catalog_cache.o $(o)catalog/catalog.o $(o)catalog/column_catalog.o $(o)catalog/column_stats_catalog.o \
...
$(o)catalog/trigger_catalog.o $(o)catalog/zone_map_catalog.o $(o)catalog/database_metrics_catalog.o $(o)catalog/index_metrics_catalog.o $(o)catalog/query_metrics_catalog.o $(o)catalog/table_metrics_catalog.o
...
# Common
LIB-common-p := $(o)common/container/circular_buffer.o $(o)common/container/cuckoo_map.o $(o)common/container/lock_free_array.o $(o)common/allocator.o \
...
# Concurrency
LIB-concurrency-p := $(o)concurrency/decentralized_epoch_manager.o $(o)concurrency/epoch_manager_factory.o $(o)concurrency/local_epoch.o \
...
# Executor
LIB-executor-p := $(o)executor/abstract_executor.o $(o)executor/abstract_join_executor.o $(o)executor/abstract_scan_executor.o $(o)executor/aggregate_executor.o \
...
# Expression
LIB-expression-p := $(o)expression/abstract_expression.o $(o)expression/aggregate_expression.o $(o)expression/case_expression.o $(o)expression/comparison_expression.o \
...
# Function
LIB-function-p := $(o)function/date_functions.o $(o)function/functions.o $(o)function/numeric_functions.o $(o)function/old_engine_string_functions.o \
$(o)function/string_functions.o $(o)function/timestamp_functions.o

# GC
LIB-gc-p := $(o)gc/gc_manager_factory.o $(o)gc/gc_manager.o $(o)gc/transaction_level_gc_manager.o

# Index $(o)index/art_index.o
LIB-index-p := $(o)index/art_index.o $(o)index/bwtree_index.o $(o)index/bwtree.o $(o)index/index_factory.o $(o)index/index_util.o $(o)index/index.o $(o)index/skiplist_index.o \
$(o)index/skiplist.o

# Murmur
LIB-murmur-p := $(o)murmur3/MurmurHash3.o

# Network
#LIB-network-p :=  $(o)network/connection_dispatcher_task.o $(o)network/connection_handle.o $(o)network/connection_handler_task.o $(o)network/marshal.o $(o)network/network_io_wrapper_factory.o $(o)network/network_io_wrappers.o $(o)network/peloton_server.o $(o)network/postgres_protocol_handler.o $(o)network/protocol_handler_factory.o $(o)network/protocol_handler.o

# Optimizer
LIB-optimizer-p := $(o)optimizer/stats/child_stats_deriver.o $(o)optimizer/stats/column_stats_collector.o $(o)optimizer/stats/selectivity.o $(o)optimizer/stats/stats_calculator.o \
...
# Parser
LIB-parser-p := $(o)parser/analyze_statement.o $(o)parser/copy_statement.o $(o)parser/create_statement.o $(o)parser/delete_statement.o $(o)parser/drop_statement.o \
...
# Planner
LIB-planner-p := $(o)planner/abstract_join_plan.o $(o)planner/abstract_plan.o $(o)planner/abstract_scan_plan.o $(o)planner/aggregate_plan.o $(o)planner/analyze_plan.o \
...
# Settings
LIB-settings-p := $(o)settings/settings_manager.o

# Statistics
LIB-statistics-p := $(o)statistics/abstract_metric.o $(o)statistics/access_metric.o $(o)statistics/backend_stats_context.o $(o)statistics/counter_metric.o \
...
# Storage
LIB-storage-p := $(o)storage/abstract_table.o $(o)storage/backend_manager.o $(o)storage/data_table.o $(o)storage/database.o $(o)storage/layout.o $(o)storage/storage_manager.o \
...
# Threadpool
LIB-threadpool-p := $(o)threadpool/worker_pool.o

# Traffic cop
LIB-traffic-cop-p := $(o)traffic_cop/traffic_cop.o

# Trigger
LIB-trigger-p := $(o)trigger/trigger.o

# Tuning
LIB-tuning-p := $(o)tuning/clusterer.o $(o)tuning/index_tuner.o $(o)tuning/layout_tuner.o $(o)tuning/sample.o

# Type
LIB-type-p := $(o)type/array_type.o $(o)type/bigint_type.o $(o)type/boolean_type.o $(o)type/date_type.o $(o)type/decimal_type.o $(o)type/integer_parent_type.o \
...
# Udf
#LIB-udf-p := $(o)udf/ast_nodes.o $(o)udf/udf_handler.o $(o)udf/udf_parser.o

# Util
LIB-util-p := $(o)util/file.o $(o)util/string_util.o $(o)util/stringbox_util.o $(o)util/csv_scanner.o
