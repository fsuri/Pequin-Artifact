...
SRCS += $(addprefix $(d), tpcc_client.cc tpcc_transaction.cc new_order.cc payment.cc order_status.cc stock_level.cc delivery.cc tpcc_generator.cc tpcc_utils.cc) #parallel version
#SRCS += $(addprefix $(d), tpcc_client.cc tpcc_transaction.cc new_order_sequential.cc payment_sequential.cc order_status.cc stock_level.cc delivery_sequential.cc tpcc_generator.cc tpcc_utils.cc) #sequential version
