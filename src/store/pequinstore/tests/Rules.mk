...
SRCS += $(addprefix $(d), proto_bench.cc tbb_test.cc compression_test.cc snapshot_test.cc table_loader_test.cc write_parser_test.cc)
...
$(d)write_parser_test: $(o)write_parser_test.o

BINS += $(d)proto_bench $(d)tbb_test $(d)compression_test $(d)snapshot_test $(d)table_loader_test $(d)write_parser_test
