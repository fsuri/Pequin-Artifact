...
$(d)compression_test: $(LIB-transport) $(LIB-latency) $(LIB-crypto) $(LIB-batched-sigs) $(LIB-store-common) $(LIB-proto) $(LIB-sintr-common) $(o)compression_test.o
$(d)snapshot_test: $(LIB-transport) $(LIB-latency) $(LIB-crypto) $(LIB-batched-sigs) $(LIB-store-common) $(LIB-proto) $(LIB-sintr-common) $(o)snapshot_test.o
$(d)table_loader_test: $(o)table_loader_test.o
$(d)sql_interpreter_test: $(LIB-transport) $(LIB-latency) $(LIB-crypto) $(LIB-batched-sigs) $(LIB-store-common) $(LIB-proto) $(LIB-sintr-common) $(o)sql_interpreter_test.o
$(d)table_store_interface_test: $(LIB-store-backend) $(LIB-tcptransport) $(LIB-sintr-store) $(o)table_store_interface_test.o
