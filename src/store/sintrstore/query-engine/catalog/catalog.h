...
class Catalog {
 public:
  const sintrstore::QueryParameters *query_params = nullptr;
  const sintrstore::QueryParameters * GetQueryParams();
  void SetQueryParams(const sintrstore::QueryParameters *query_params);
