...
class CSVScanner {
 public:
   ...
   */
  CSVScanner(peloton_peloton::type::AbstractPool &memory, const std::string &file_path,
             const type::Type *col_types, uint32_t num_cols,
  ...
  static void Init(CSVScanner &scanner,
                   ...
                   const char *file_path, const type::Type *col_types,
 ...
 private:
  ...
  peloton_peloton::type::AbstractPool &memory_;

  // The path to the CSV file
  const std::string file_path_;

  // The CSV file handle
  peloton_peloton::util::File file_;
