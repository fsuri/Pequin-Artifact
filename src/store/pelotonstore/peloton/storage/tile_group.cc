...
const std::string TileGroup::GetInfo() const {
  ...
  os << peloton_peloton::GETINFO_DOUBLE_STAR << " TILE GROUP[#" << tile_group_id << "] "
     << peloton_peloton::GETINFO_DOUBLE_STAR << std::endl;
  ...
  return peloton_peloton::StringUtil::Prefix(peloton_peloton::StringBoxUtil::Box(os.str()),
                                     GETINFO_SPACER);
}
