...
SRCS += $(addprefix $(d), client.cc shardclient.cc server.cc server_fallback.cc servertools.cc concurrencycontrol.cc store.cc common.cc \
		...
		querysync-server.cc querysync-servertools.cc querysync-client.cc queryexec.cc checkpointing.cc snapshot_mgr.cc sql_interpreter.cc ) # table_store_interface.cc)
...
LIB-pequin-store := $(o)server.o $(o)server_fallback.o $(o)servertools.o $(o)querysync-server.o $(o)querysync-servertools.o $(o)concurrencycontrol.o $(LIB-latency) \
