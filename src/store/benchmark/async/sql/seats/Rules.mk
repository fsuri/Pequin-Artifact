...
SRCS += $(addprefix $(d), seats_client.cc seats_transaction.cc seats_generator.cc delete_reservation.cc find_flights.cc find_open_seats.cc new_reservation.cc update_customer.cc update_reservation.cc reservation.cc cached_flight.cc)
...
$(d)sql_seats_generator: $(LIB-io-utils) $(o)seats_generator.o
